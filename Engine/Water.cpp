...
bool Water::Initialize(ID3D11Device* device, WCHAR* textureFilename, float waterHeight, float waterRadius)
{
	...
	m_refractionTint = DirectX::SimpleMath::Vector4(0.0f, 0.8f, 1.0f, 1.0f);
...
DirectX::SimpleMath::Vector2 Water::GetNormalMapTiling()
{
...
DirectX::SimpleMath::Vector4 Water::GetRefractionTint()
{
...
bool Water::InitializeBuffers(ID3D11Device* device, float waterRadius)
{
	...
	if (!indices)
	{
		...
		vertices[0].position = DirectX::SimpleMath::Vector3(-waterRadius, 0.0f, waterRadius);  // Top left.
	vertices[0].texture = DirectX::SimpleMath::Vector2(0.0f, 0.0f);

	vertices[1].position = DirectX::SimpleMath::Vector3(waterRadius, 0.0f, waterRadius);  // Top right.
	vertices[1].texture = DirectX::SimpleMath::Vector2(1.0f, 0.0f);

	vertices[2].position = DirectX::SimpleMath::Vector3(-waterRadius, 0.0f, -waterRadius);  // Bottom left.
	vertices[2].texture = DirectX::SimpleMath::Vector2(0.0f, 1.0f);

	vertices[3].position = DirectX::SimpleMath::Vector3(-waterRadius, 0.0f, -waterRadius);  // Bottom left.
	vertices[3].texture = DirectX::SimpleMath::Vector2(0.0f, 1.0f);

	vertices[4].position = DirectX::SimpleMath::Vector3(waterRadius, 0.0f, waterRadius);  // Top right.
	vertices[4].texture = DirectX::SimpleMath::Vector2(1.0f, 0.0f);

	vertices[5].position = DirectX::SimpleMath::Vector3(waterRadius, 0.0f, -waterRadius);  // Bottom right.
